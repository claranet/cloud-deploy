...
def test_buildimage_ami(awsimagebuilder_mock):
    """
    ...
    assert awsimagebuilder_mock.called == 1
...
@mock.patch('ghost_tools.log', new=mocked_logger)
@mock.patch('ghost_aws.log', new=mocked_logger)
def test_buildimage_ami_error(awsimagebuilder_mock):
    """
...
def test_buildimage_lxd(AWSImageBuilder_mock, LXDImageBuilder_mock):
    ...
    assert AWSImageBuilder_mock.called == 1
    assert LXDImageBuilder_mock.called == 1
