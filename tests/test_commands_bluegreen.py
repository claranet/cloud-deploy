...
@mock.patch('commands.preparebluegreen.check_app_manifest', new=lambda a, b, c, d: True)
...
@mock.patch('commands.swapbluegreen.check_app_manifest', new=lambda a, b, c, d: True)
