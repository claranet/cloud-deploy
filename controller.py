...
queue = Queue(connection=redis_conn_queue, default_timeout=1800)
...
@check_mandatory(['app', 'role', 'env', 'git_repo', 'git_login', 'git_password', 'key_path', 'bucket_s3', 'bucket_region', 'aws_region', 'notif_arn'])
def register_app(data):
    ...
    bucket_region: Region where the S3 Bucket is located
